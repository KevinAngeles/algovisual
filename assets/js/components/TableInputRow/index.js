  ...
  render() {
    return(
      <tr>
        ...
        <td className="p-0"><Button id="clearAll" color="danger" data-key={this.props.row.idx} onClick={ ev => this.props.removeProcess(parseInt(ev.target.getAttribute('data-key')), this.props.routeProps.match.params.id) }>Remove</Button></td>
      </tr>
    );
  }
}
